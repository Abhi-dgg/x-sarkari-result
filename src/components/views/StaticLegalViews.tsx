...
import { ShieldCheck, Mail, Send, AlertTriangle, CheckCircle2, Phone, MapPin, Building2, HelpCircle } from 'lucide-react';
...
export const StaticLegalViews: React.FC<StaticLegalViewsProps> = ({ viewType, onNavigate }) => {
  // Contact Form State
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      ...
      {/* ========================================================= */}
      {viewType === 'about' && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-10 space-y-6">
          ...
          <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed space-y-4">
            <p>
              <strong>X Sarkari Job (xsarkarijob.com)</strong> is an independent educational and career information platform founded with a single mission: to simplify, organize, and accelerate access to official Indian government employment opportunities, examination schedules, admit cards, and scorecards.
            </p>

            <h3 className="text-base font-bold text-gray-900 pt-2">Our Core Principles</h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 not-prose">
              <div className="p-4 bg-amber-50 rounded-lg border border-amber-200">
                ...
                <h4 className="text-sm font-bold text-gray-900">Source Verification</h4>
                <p className="text-xs text-gray-600 mt-1">Every post links directly to statutory commission notifications and official portals.</p>
              </div>
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <CheckCircle2 className="w-6 h-6 text-blue-600 mb-2" />
                <h4 className="text-sm font-bold text-gray-900">No Clickbait Or Rumors</h4>
                <p className="text-xs text-gray-600 mt-1">We do not publish speculative dates or unconfirmed news. Real gazette data only.</p>
              </div>
              <div className="p-4 bg-emerald-50 rounded-lg border border-emerald-200">
                <Building2 className="w-6 h-6 text-emerald-600 mb-2" />
                <h4 className="text-sm font-bold text-gray-900">All-India Coverage</h4>
                <p className="text-xs text-gray-600 mt-1">Comprehensive tracking of Central SSC, UPSC, RRB and State Police, PSCs, and Teacher boards.</p>
              </div>
            </div>

            <h3 className="text-base font-bold text-gray-900 pt-4">Our Technology</h3>
            <p>
      ...
      {viewType === 'contact' && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-2.5 rounded-lg text-sm transition-colors cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50"
                  >
            ...
            <div className="lg:col-span-5 bg-gray-50 p-6 rounded-xl border border-gray-200 text-xs space-y-4">
      ...
      {viewType === 'disclaimer' && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-10 space-y-6">
          ...
          <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed space-y-4">
            <div className="p-4 bg-amber-50 rounded-lg border border-amber-200 text-amber-950 font-medium text-xs sm:text-sm">
            ...
            <h3 className="text-base font-bold text-gray-900">1. Information Accuracy and Verification</h3>
            <p>
            ...
            <h3 className="text-base font-bold text-gray-900">2. Non-Liability</h3>
            <p>
            ...
            <h3 className="text-base font-bold text-gray-900">3. External Links & Official Logos</h3>
            <p>
      ...
      {viewType === 'privacy-policy' && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-10 space-y-6">
          <div className="border-b border-gray-100 pb-4">
            ...
            <p className="text-xs text-gray-500 mt-1">Effective Date: September 1, 2026</p>
          </div>

          <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed space-y-4">
            <p>
              At <strong>X Sarkari Job</strong>, accessible from xsarkarijob.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document outlines the types of information that is collected and recorded by X Sarkari Job and how we use it.
            </p>
            ...
            <h3 className="text-base font-bold text-gray-900">Log Files & Cookies</h3>
            <p>
            ...
            <h3 className="text-base font-bold text-gray-900">Google AdSense and Advertising Partners</h3>
            <p>
      ...
      {viewType === 'terms' && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-10 space-y-6">
          <div className="border-b border-gray-100 pb-4">
            ...
            <p className="text-xs text-gray-500 mt-1">Last Revised: September 2026</p>
          </div>

          <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed space-y-4">
            <p>
              Welcome to <strong>X Sarkari Job</strong>. By accessing or using this website, you agree to be bound by these terms and conditions. If you disagree with any part of these terms, please do not use our website.
            </p>
            <h3 className="text-base font-bold text-gray-900">Use License</h3>
            <p>
      ...
      {viewType === 'cookie-policy' && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-10 space-y-6">
          ...
          <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed space-y-4">
            ...
            <h3 className="text-base font-bold text-gray-900">Disabling Cookies</h3>
            <p>
